# 豆瓣 Top 100 电影爬虫项目 (面向对象设计 & 可视化驱动)

## 项目概述
本项目实现了一个基于**面向对象编程 (OOP)** 的网页爬虫，用于抓取豆瓣排名前 100 的电影数据。为了符合真实的软件工程规范，本项目的数据库结构采用了**“自顶向下 (Top-Down)”**的设计思想——即先设定预期的数据可视化展示需求，再反向推导并设计数据库字段。
